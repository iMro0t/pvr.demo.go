...
typedef const PVR_CHANNEL cPVR_CHANNEL_t;
typedef const PVR_MENUHOOK cPVR_MENUHOOK_t;
typedef const PVR_MENUHOOK_DATA cPVR_MENUHOOK_DATA_t;
typedef const PVR_CHANNEL_GROUP cPVR_CHANNEL_GROUP_t;
typedef const ADDON_HANDLE cADDON_HANDLE_t;
/*!
...
extern "C"
{
  ...
  //  */
  extern PVR_ERROR GetDriveSpace(long long *iTotal, long long *iUsed);
  ...
  //  * @remarks Optional. Return PVR_ERROR_NOT_IMPLEMENTED if this add-on won't provide this function.
  //  */
  extern PVR_ERROR CallMenuHook(cPVR_MENUHOOK_t *menuhook, cPVR_MENUHOOK_DATA_t *item);
  // //@}
  ...
  //  */
  extern PVR_ERROR GetEPGForChannel(ADDON_HANDLE handle, cPVR_CHANNEL_t *channel, time_t iStart, time_t iEnd);
  ...
  //  */
  extern PVR_ERROR IsEPGTagRecordable(cEPG_TAG_t *tag, bool *bIsRecordable);
  ...
  //  *          Return PVR_ERROR_NOT_IMPLEMENTED if this add-on won't provide this function.
  //  */
  extern PVR_ERROR IsEPGTagPlayable(cEPG_TAG_t *tag, bool *bIsPlayable);
  ...
  //  *          Return PVR_ERROR_NOT_IMPLEMENTED if this add-on won't provide this function.
  //  */
  extern PVR_ERROR GetEPGTagEdl(cEPG_TAG_t *epgTag, PVR_EDL_ENTRY edl[], int *size);
  ...
  //  *          Return PVR_ERROR_NOT_IMPLEMENTED if this add-on won't provide this function.
  //  */
  extern PVR_ERROR GetEPGTagStreamProperties(cEPG_TAG_t *tag, PVR_NAMED_VALUE *properties, unsigned int *iPropertiesCount);
  ...
  //  */
  extern int GetChannelGroupsAmount(void);
  ...
  //  *          Return PVR_ERROR_NOT_IMPLEMENTED if this add-on won't provide this function.
  //  */
  extern PVR_ERROR GetChannelGroups(ADDON_HANDLE handle, bool bRadio);
  ...
  //  *          Return PVR_ERROR_NOT_IMPLEMENTED if this add-on won't provide this function.
  //  */
  extern PVR_ERROR GetChannelGroupMembers(ADDON_HANDLE handle, cPVR_CHANNEL_GROUP_t *group);
  // //@}
  ...
  //  */
  extern PVR_ERROR OpenDialogChannelScan(void);

  // /*!
  //  * @return The total amount of channels on the backend, or -1 on error.
  //  * @remarks Valid implementation required.
  //  */
  extern int GetChannelsAmount(void);
  ...
  //  */
  extern PVR_ERROR GetChannels(ADDON_HANDLE handle, bool bRadio);
  ...
  //  */
  extern PVR_ERROR DeleteChannel(cPVR_CHANNEL_t *channel);
  ...
  //  *          Return PVR_ERROR_NOT_IMPLEMENTED if this add-on won't provide this function.
  //  */
  extern PVR_ERROR RenameChannel(cPVR_CHANNEL_t *channel);
  ...
  //  * @note see libKODI_guilib.h about related parts
  //  */
  extern PVR_ERROR OpenDialogChannelSettings(cPVR_CHANNEL_t *channel);
  ...
  //  * @note see libKODI_guilib.h about related parts
  //  */
  extern PVR_ERROR OpenDialogChannelAdd(cPVR_CHANNEL_t *channel);
  // //@}
  ...
  //  */
  extern int GetRecordingsAmount(bool deleted);
  ...
  //  *          Return PVR_ERROR_NOT_IMPLEMENTED if this add-on won't provide this function.
  //  */
  extern PVR_ERROR GetRecordings(ADDON_HANDLE handle, bool deleted);
  ...
  //  *          Return PVR_ERROR_NOT_IMPLEMENTED if this add-on won't provide this function.
  //  */
  extern PVR_ERROR DeleteRecording(cPVR_RECORDING_t *recording);
  ...
  //  *          Return PVR_ERROR_NOT_IMPLEMENTED if this add-on won't provide this function.
  //  */
  extern PVR_ERROR UndeleteRecording(cPVR_RECORDING_t *recording);
  ...
  //  */
  extern PVR_ERROR DeleteAllRecordingsFromTrash();
  ...
  //  *          Return PVR_ERROR_NOT_IMPLEMENTED if this add-on won't provide this function.
  //  */
  extern PVR_ERROR RenameRecording(cPVR_RECORDING_t *recording);
  ...
  //  *          Return PVR_ERROR_NOT_IMPLEMENTED if this add-on won't provide this function.
  //  */
  extern PVR_ERROR SetRecordingLifetime(cPVR_RECORDING_t *recording);
  ...
  //  *          Return PVR_ERROR_NOT_IMPLEMENTED if this add-on won't provide this function.
  //  */
  extern PVR_ERROR SetRecordingPlayCount(cPVR_RECORDING_t *recording, int count);
  ...
  //  *          Return PVR_ERROR_NOT_IMPLEMENTED if this add-on won't provide this function.
  //  */
  extern PVR_ERROR SetRecordingLastPlayedPosition(cPVR_RECORDING_t *recording, int lastplayedposition);
  ...
  //  *          Return -1 if this add-on won't provide this function.
  //  */
  extern int GetRecordingLastPlayedPosition(cPVR_RECORDING_t *recording);
  ...
  //  *          Return PVR_ERROR_NOT_IMPLEMENTED if this add-on won't provide this function.
  //  */
  extern PVR_ERROR GetRecordingEdl(cPVR_RECORDING_t *recording, PVR_EDL_ENTRY edl[], int *size);
  ...
  //  *          Return PVR_ERROR_NOT_IMPLEMENTED if this add-on won't provide this function.
  //  */
  extern PVR_ERROR GetTimerTypes(PVR_TIMER_TYPE types[], int *typesCount);
  ...
  //  */
  extern int GetTimersAmount(void);
  ...
  //  *          Return PVR_ERROR_NOT_IMPLEMENTED if this add-on won't provide this function.
  //  */
  extern PVR_ERROR GetTimers(ADDON_HANDLE handle);
  ...
  //  *          Return PVR_ERROR_NOT_IMPLEMENTED if this add-on won't provide this function.
  //  */
  extern PVR_ERROR AddTimer(cPVR_TIMER_t *timer);
  ...
  //  *          Return PVR_ERROR_NOT_IMPLEMENTED if this add-on won't provide this function.
  //  */
  extern PVR_ERROR DeleteTimer(cPVR_TIMER_t *timer, bool bForceDelete);
  ...
  //  *          Return PVR_ERROR_NOT_IMPLEMENTED if this add-on won't provide this function.
  //  */
  extern PVR_ERROR UpdateTimer(cPVR_TIMER_t *timer);
  ...
  //  */
  extern bool OpenLiveStream(cPVR_CHANNEL_t *channel);

  // /*!
  //  * Close an open live stream.
  //  * @remarks Required if bHandlesInputStream or bHandlesDemuxing is set to true.
  //  */
  extern void CloseLiveStream(void);
  ...
  //  *          Return -1 if this add-on won't provide this function.
  //  */
  extern int ReadLiveStream(unsigned char *pBuffer, unsigned int iBufferSize);
  ...
  //  *          Return -1 if this add-on won't provide this function.
  //  */
  extern long long SeekLiveStream(long long iPosition, int iWhence);
  ...
  //  *          Return -1 if this add-on won't provide this function.
  //  */
  extern long long LengthLiveStream(void);
  ...
  //  *          Return PVR_ERROR_NOT_IMPLEMENTED if this add-on won't provide this function.
  //  */
  extern PVR_ERROR SignalStatus(PVR_SIGNAL_STATUS *signalStatus);
  ...
  //  *          Return PVR_ERROR_NOT_IMPLEMENTED if this add-on won't provide this function.
  //  */
  extern PVR_ERROR GetDescrambleInfo(PVR_DESCRAMBLE_INFO *descrambleInfo);
  ...
  //  *          Return PVR_ERROR_NOT_IMPLEMENTED if this add-on won't provide this function.
  //  */
  extern PVR_ERROR GetChannelStreamProperties(cPVR_CHANNEL_t *channel, PVR_NAMED_VALUE *properties, unsigned int *iPropertiesCount);
  ...
  //  *          Return PVR_ERROR_NOT_IMPLEMENTED if this add-on won't provide this function.
  //  */
  extern PVR_ERROR GetRecordingStreamProperties(cPVR_RECORDING_t *recording, PVR_NAMED_VALUE *properties, unsigned int *iPropertiesCount);
  ...
  //  *          Return PVR_ERROR_NOT_IMPLEMENTED if this add-on won't provide this function.
  //  */
  extern PVR_ERROR GetStreamProperties(PVR_STREAM_PROPERTIES *pProperties);
  // //@}
  ...
  //  */
  extern PVR_ERROR GetStreamReadChunkSize(int *chunksize);
  ...
  //  *          Return false if this add-on won't provide this function.
  //  */
  extern bool OpenRecordedStream(cPVR_RECORDING_t *recording);

  // /*!
  //  * Close an open stream from a recording.
  //  * @remarks Optional, and only used if bSupportsRecordings is set to true.
  //  */
  extern void CloseRecordedStream(void);
  ...
  //  *          Return -1 if this add-on won't provide this function.
  //  */
  extern int ReadRecordedStream(unsigned char *pBuffer, unsigned int iBufferSize);
  ...
  //  *          Return -1 if this add-on won't provide this function.
  //  */
  extern long long SeekRecordedStream(long long iPosition, int iWhence);
  ...
  //  *          Return -1 if this add-on won't provide this function.
  //  */
  extern long long LengthRecordedStream(void);
  ...
  //  * @remarks Required if bHandlesDemuxing is set to true.
  //  */
  extern void DemuxReset(void);

  // /*!
  //  * Abort the demultiplexer thread in the add-on.
  //  * @remarks Required if bHandlesDemuxing is set to true.
  //  */
  extern void DemuxAbort(void);

  // /*!
  //  * Flush all data that's currently in the demultiplexer buffer in the add-on.
  //  * @remarks Required if bHandlesDemuxing is set to true.
  //  */
  extern void DemuxFlush(void);
  ...
  //  */
  extern DemuxPacket *DemuxRead(void);
  // //@}
  ...
  //  *          Return False if this add-on won't provide this function.
  //  */
  extern bool SeekTime(double time, bool backwards, double *startpts);
